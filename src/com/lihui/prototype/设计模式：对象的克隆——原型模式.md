title: 设计模式：对象的克隆——原型模式
date: 2015-07-24 10:17:03
categories: 设计模式
tags: 设计模式
---
...
![图1 工作周报示意图](http://7xk5ao.com1.z0.glb.clouddn.com/prototype1.gif)
...
原型模式的结构如图2所示：
![图2 原型模式结构图](http://7xk5ao.com1.z0.glb.clouddn.com/prototype2.gif)
